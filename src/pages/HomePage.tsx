      ...
      <section className="bg-primary-800/50 py-20">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-metal-400 max-w-2xl mx-auto">
              Hear from car enthusiasts who use our platform to explore and learn about their favorite vehicles
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Testimonial
              quote="The 3D models are incredibly detailed. I can examine every aspect of a car before making a decision."
            ...
            />
            <Testimonial
              quote="As a car collector, this platform has been invaluable for researching new additions to my collection."
              author="Sophia Chen"
            ...
            />
            <Testimonial
              quote="The community features let me connect with fellow enthusiasts who share my passion for hypercars."
